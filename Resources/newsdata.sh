...
#6pm
#12am
say "starting launchd run" #helps to debug background process!
echo "Running Training Data Capture"
echo "Downloading Headlines for $(date)"

CURRENT_DATE=$(date +"%Y-%m-%d-%I-%M%p")
OUTPUT_FILE="/Users/jwamin/sandbox.nosync/beta-projects-2019-20/Snooz/Resources/out/news-headlines-${CURRENT_DATE}.json"
